...
class AllReceiptItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) => ReceiptItem(name:'error' ,price: 0,quantity: 0,subtotal: 0,),
    );
  }
}
...
final VoidCallback ontap;
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      itemCount: Mrawan.names.length,
      itemBuilder: (context, index) => ReceiptItem(name:'error' ,price: 0,quantity: 0,subtotal: 0,ontap: ontap,),
    );
  }
}
